# ============================================================================
# KD STUDENT BACKBONE ABLATION — DenseNet-121 student
# ============================================================================
...
# TEK FARK: backbone efficientnet_b4 → densenet121
...
SAVE_DIR = os.path.join(DATA_ROOT, 'results_distillation_densenet')
os.makedirs(SAVE_DIR, exist_ok=True)

STUDENT_BACKBONE = 'densenet121'   # ← v3'te efficientnet_b4 idi
...
# ─────────────────────────────────────────────
class StudentModelDenseNet(nn.Module):
    def __init__(self, num_main=NUM_MAIN, num_rare=NUM_RARE, emb_dim=EMB_DIM):
        ...
        backbone_dim = self.backbone.num_features  # densenet121 → 1024
...
for fold, (train_idx, val_idx) in enumerate(splits):
    ...
    model = StudentModelDenseNet().to(DEVICE)
